...
void Peripherals_Init(void)
{
    ...
    DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)U2_DataTypeStructure.Tx_Buff;
    DMA_InitStructure.DMA_BufferSize         = 14 + U2_ServoNum;
    ...
    DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)U3_DataTypeStructure.Tx_Buff;
    ...
    DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)U4_DataTypeStructure.Tx_Buff;
